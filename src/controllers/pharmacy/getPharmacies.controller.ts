...
import { getPharmaciesServices } from "../../services/pharmacy/getPharmacies.services";

export const getPharmaciesController = async (req: Request, res: Response): Promise<any> => {
    try {

        const result = await getPharmaciesServices();
        if (!result) {
